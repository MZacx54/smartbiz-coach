...
const LandingPage: React.FC = () => {
    ...
    // ── DATA ──
    const allFeatures = [
        { icon: '📸', title: 'AI Snap & List', desc: 'Photograph any product and our vision AI instantly creates the listing — name, price, category, and sales copy. Onboard 50 products in minutes.', color: 'from-violet-500 to-purple-600', tag: 'New' },
        ...
        { icon: '🏪', title: 'Unified Marketplace', desc: 'List your products, services, properties, or B2B offers on our Nigerian SME marketplace — with WhatsApp lead routing built in.', color: 'from-green-500 to-emerald-600', tag: 'New' },
        { icon: '📦', title: 'Advanced Inventory', desc: 'Physical goods, services, real estate, wholesale — every product type with its own smart metadata fields and AI classification.', color: 'from-sky-500 to-cyan-600', tag: 'Upgraded' },
        { icon: '💬', title: 'WhatsApp Sales Closer', desc: 'Never lose a sale again. Get AI-crafted responses for objections, follow-ups, and closing — ready to paste into WhatsApp.', color: 'from-lime-500 to-green-600' },
        { icon: '⚖️', title: 'CAC Compliance Checker', desc: 'Navigate CAC registration, TIN, SCUML, and NAFDAC requirements. Get a step-by-step checklist for your business type.', color: 'from-teal-500 to-cyan-600' },
        { icon: '📊', title: 'Transaction Ledger', desc: 'Track every sale, purchase, and expense with a professional investor-ready financial ledger that NGOs and banks accept.', color: 'from-slate-500 to-gray-600', tag: 'New' },
    ];
    ...
    const featureTabs = [
        {
            ...
            body: 'No more typing product names one by one. Our AI Vision technology reads your photos and instantly generates the product name, category, estimated price, and a compelling sales description. Just review, edit, and publish.',
            bullets: [
        ...
        },
        {
            ...
            headline: 'One inventory system for every business type',
            subheadline: 'Physical. Service. Property. B2B. All covered.',
            body: 'The first Nigerian inventory system that understands the difference between selling fabric, renting apartments, dispatching cargo, and closing brand deals. Each category has its own smart fields so your listings look professional and attract the right buyers.',
            bullets: [
                '🛍️ Physical goods — brand, SKU, weight, variants',
                '🛠️ Services — billing type, delivery timeline, experience level',
                '🏠 Properties — beds, baths, furnished status, Naija specs (power, water)',
                '🤝 B2B Hub — Logistics vehicles, Wholesale MOQ, Influencer reach, Raw material grades',
                '🤖 AI sales copy that adapts to your specific category',
            ],
        ...
        {
            label: '💬 WhatsApp CRM',
            headline: 'Every inquiry becomes a sales lead you can track',
            subheadline: 'From marketplace to closed deal on WhatsApp.',
            body: 'When a buyer finds your listing on the marketplace, one click opens a pre-filled WhatsApp chat directed to you. The inquiry is automatically logged in your CRM ledger — so you never miss a lead, and every follow-up is tracked.',
            bullets: [
                '💬 "Contact via WhatsApp" button on every B2B/Service/Property listing',
                '📝 Pre-filled professional inquiry message for buyers',
                '📋 Leads automatically saved to your CRM dashboard',
                '🔔 Debt tracker sends AI reminders to recovering cash',
                '📊 Full lead history and conversion tracking',
            ],
