...
const BusinessPlanGenerator: React.FC<BusinessPlanGeneratorProps> = ({ brand, businessName, credits, onUpdateCredits }) => {
  ...
  const handleDownloadPDF = () => {
    ...
    doc.text(name.toUpperCase(), 105, 30, { align: "center" });
    
    doc.setFontSize(14);
    doc.setFont("helvetica", "normal");
    doc.setTextColor(75, 85, 99); // Slate-500
    doc.text("Strategic Business Plan", 105, 40, { align: "center" });
    
    doc.setFontSize(10);
    doc.text("Generated by SmartBiz Coach AI", 105, 48, { align: "center" });
